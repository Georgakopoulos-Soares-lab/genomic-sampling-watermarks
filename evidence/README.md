...
namespace, a fresh cohort, a new frozen protocol, and a documented execution environment. Results
from removed watermark methods and their experiments are not retained.
