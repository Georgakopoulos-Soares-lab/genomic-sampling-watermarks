#!/usr/bin/env python3
"""Run the frozen GENERATOR position-independent SynthID detector validation."""
...
DEFAULT_VALIDATION_ROOT = Path("/scratch/10899/kimopro/generator_synthid_validation_hpc_v4")
...
DEFAULT_PROTOCOL = (
    ROOT / "docs/research/generator_synthid_position_independent_validation_protocol.md"
)
...
def finalize(
    *,
    ...
    summary: dict[str, Any] = {
        ...
        "provenance": {
            "command": "scripts/run_generator_synthid_position_independent.py",
            ...
            "validator": {
                "path": str(
                    (ROOT / "scripts/validate_generator_synthid_position_independent.py").resolve()
                ),
                "sha256": sha256_file(
                    ROOT / "scripts/validate_generator_synthid_position_independent.py"
                ),
            },
        },
