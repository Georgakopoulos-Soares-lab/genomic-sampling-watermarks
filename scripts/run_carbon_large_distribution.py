#!/usr/bin/env python3
"""Resumable one-step audit of the Carbon SynthID tournament sampler."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--experiment-label", default="carbon-synthid-validation-v1/distribution")
...
def finalize(
    *,
    ...
    summary = {
        ...
        "state_selection": (
            "declared C_tok law after the first 64 tokens of draw-0's ordinary trajectory"
        ),
        "state_token_index": args.state_token_index,
        ...
        "boundary": (
            ...
            "ordinary arm is tested against C_tok. A fixed key and context intentionally reweight "
