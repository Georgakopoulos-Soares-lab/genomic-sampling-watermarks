#!/usr/bin/env python3
"""Held-out, aligned SynthID detection for the Carbon validation corpus."""
    ...
    *,
    ...
    summary = {
        ...
        "threshold_source": (
            ...
            if args.threshold_source == "analytic"
            else "calibration ordinary Carbon plus corresponding draw key only"
        ),
...
def main() -> int:
    ...
    selected_split_record = {
        "schema_version": 1,
        "label": "carbon_synthid_validation_v1/prompt-split/v1",
        "assignment_rule": (
    ...
    if pending:
        ...
        stream_domain = f"{args.experiment_label}/{cases[0].cohort_id}/C_tok"
