#!/usr/bin/env python3
"""Render the Carbon SynthID validation report from immutable summaries."""
...
def main() -> int:
    ...
    lines = [
        "# Carbon-500M `C_tok` SynthID tournament validation"
    ...
    lines.extend(
        [
            ...
            (
                ...
                + gof_resolution_note
                + "Fixed-key tournament laws are intentionally reweighted relative to C_tok; "
            ...
            (
                "6. **Carbon NLL/perplexity:** mean NLL/token difference "
            ...
            "## Claim separation",
            "",
            "- Experiment A checks ordinary samples against `C_tok`, tournament samples against "
            ...
            "change Carbon.’ Fixture keys are public reproducibility material, and proxy "
